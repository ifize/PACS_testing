...
class Modalities(models.Model):
    ...
    name = models.CharField(max_length=250,
                            verbose_name='Наименование модальности')
...
class Studies(models.Model):
    ...
    study_uid = models.UUIDField(
        verbose_name='Идентификатор исследования во внешней системе')
    study_date = models.DateTimeField(verbose_name='Дата и время исследования')
    study_modality = models.ForeignKey(Modalities, on_delete=models.DO_NOTHING,
                                       verbose_name='Модальность исследования')
